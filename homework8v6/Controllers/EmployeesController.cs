...
namespace homework8v6.Controllers
{
    public class EmployeesController : Controller
    {
        private readonly homework8v6Context _context;

        public EmployeesController(homework8v6Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(string employeeDepartment, string searchString)
        {
            ...
            IQueryable<string> departmentQuery = from emp in _context.Employee
        ...
        public async Task<IActionResult> Create([Bind("Id,FullName,Department, Position")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FullName,Department,Position")] Employee employee)
        {
            if (id != employee.Id)
            {
                return NotFound();
